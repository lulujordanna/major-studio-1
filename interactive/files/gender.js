...
function initialize(params) {
    ...
    d3.select("#myCheckbox2").on("click",function(){update(params);});
...
function setUpColors() {
    return d3.scaleOrdinal().range(["#f3dc50", "#b43175", "#c9c7c7", "#000000"]);
}
